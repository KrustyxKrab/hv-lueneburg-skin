...
if ( ! function_exists( 'topscorer_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function topscorer_get_filter_items( $params ) {
		...
		return apply_filters( 'topscorer_filter_get_filter_items', $items, $params );
	}
}