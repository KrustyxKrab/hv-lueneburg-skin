...
$player_image        = get_post_thumbnail_id( $player_id );
...
echo topscorer_core_get_list_shortcode_item_image( $image_dimension, $player_image, $custom_image_width, $custom_image_height );