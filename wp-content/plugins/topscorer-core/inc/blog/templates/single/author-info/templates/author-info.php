<?php
$is_enabled = topscorer_core_get_post_value_through_levels( 'qodef_blog_single_enable_author_info' );

if ( $is_enabled === 'yes' && get_the_author_meta( 'description' ) !== '' ) {
	$author_id     = get_the_author_meta( 'ID' );
	$author_link   = get_author_posts_url( $author_id );
	$email_enabled = topscorer_core_get_post_value_through_levels( 'qodef_blog_single_enable_author_info_email' ) === 'yes';
	$user_socials  = topscorer_core_get_author_social_networks( $author_id );
	?>
        ...
        <div class="qodef-m-inner">
            ...
            <div class="qodef-m-content">
                <h4 class="qodef-m-author vcard author">
                    <span class="qodef-m-author-label"><?php esc_html_e( 'The author', 'topscorer-core' ); ?></span>
