...
if ( ! function_exists( 'topscorer_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function topscorer_core_add_twitter_list_shortcode( $shortcodes ) {
		if( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'TopScorerCoreTwitterListShortcode';
		}
		
		return $shortcodes;
	}
	
	add_filter( 'topscorer_core_filter_register_shortcodes', 'topscorer_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'TopScorerCoreListShortcode' ) ) {
	class TopScorerCoreTwitterListShortcode extends TopScorerCoreListShortcode {
		
		public function map_shortcode() {
			$this->set_shortcode_path( TOPSCORER_CORE_INC_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'topscorer_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'topscorer-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'topscorer-core' ) );
			...
			$this->set_option( array(
				...
				'field_type' => 'text',
				'title'      => esc_html__( 'Number of Tweets', 'topscorer-core' ),
				'group'      => esc_html__( 'Info', 'topscorer-core' ),
				'description' => esc_html__( 'Default value is 3', 'topscorer-core' )
			) );
			$this->set_option( array(
				'name'          => 'show_retweeted_text',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Retweeted Text', 'topscorer-core' ),
			...
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Avatar Image', 'topscorer-core' ),
				'options'       => topscorer_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'topscorer-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Author Name', 'topscorer-core' ),
				'options'       => topscorer_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'topscorer-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Text', 'topscorer-core' ),
				'options'       => topscorer_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'topscorer-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Media Placeholder', 'topscorer-core' ),
			...
			$this->set_option( array(
				'name'          => 'show_date',
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Date', 'topscorer-core' ),
				'options'       => topscorer_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'topscorer-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Tweet Actions', 'topscorer-core' ),
				'options'       => topscorer_core_get_select_type_options_pool( 'yes_no' ),
				'default_value' => 'yes',
				'group'         => esc_html__( 'Info', 'topscorer-core' )
			) );
			$this->set_option( array(
				...
				'field_type'    => 'select',
				'title'         => esc_html__( 'Show Twitter Link', 'topscorer-core' ),
				'options'       => topscorer_core_get_select_type_options_pool( 'no_yes' ),
				'default_value' => 'no',
				'group'         => esc_html__( 'Info', 'topscorer-core' )
			) );
		...
		public function render( $options, $content = null ) {
			...
			return topscorer_core_get_template_part( 'twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
