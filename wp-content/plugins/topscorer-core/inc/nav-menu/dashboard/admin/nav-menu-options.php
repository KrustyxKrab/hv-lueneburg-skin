...
if ( ! function_exists( 'topscorer_core_nav_menu_options' ) ) {
	function topscorer_core_nav_menu_options( $page ) {
		
		if ( $page ) {
			$section = $page->add_section_element(
				array(
					'name'  => 'qodef_nav_menu_section',
					'title' => esc_html__( 'Nav Menu', 'topscorer-core' )
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Wide Dropdown Full Width', 'topscorer-core' ),
					'default_value' => 'yes'
				)
			);
			...
			$section_dropdown_content = $section->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Wide Dropdown Full Width Section', 'topscorer-core' ),
					'dependency' => array(
						'show' => array(
			...
			$row_dropdown_content = $section_dropdown_content->add_row_element(
				array(
					...
					'title'      => esc_html__( 'Wide Dropdown Full Width Settings', 'topscorer-core' ),
					'dependency' => array(
						'show' => array(
							'qodef_wide_dropdown_full_width' => array(
								'values'        => 'yes',
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Wide Dropdown Content In Grid', 'topscorer-core' ),
					'default_value' => 'yes',
					'args'       => array(
						'col_width' => 6
					)
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Main Dropdown Menu Appearance', 'topscorer-core' ),
					'default_value' => 'default',
					'options'		=> array(
						'default'			=> esc_html__( 'Default', 'topscorer-core' ),
						'animate-height'	=> esc_html__( 'Animate Height', 'topscorer-core' ),
					),
					'args'       => array(
						'col_width' => 6
					)
			...
			$nav_menu_typography_section = $page->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Nav Menu Typography', 'topscorer-core' )
				)
			);
			...
			$first_level_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title'      => esc_html__( 'Nav First Level Typography', 'topscorer-core' )
				)
			);
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Active Color', 'topscorer-core' ),
					'args'       => array(
						'col_width' => 3
					)
				)
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Margin Left/Right', 'topscorer-core' ),
					'args'       => array(
						'col_width' => 3
					)
				)
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Padding Left/Right', 'topscorer-core' ),
					'args'       => array(
						'col_width' => 3
					)
				)
			...
			$second_level_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title'      => esc_html__( 'Nav Second Level Typography', 'topscorer-core' )
				)
			);
			...
			$second_level_wide_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title'      => esc_html__( 'Nav Second Level Wide Typography', 'topscorer-core' )
				)
			);
			...
			$third_level_wide_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title'      => esc_html__( 'Nav Third Level Wide Typography', 'topscorer-core' )
				)
			);
	...
	add_action( 'topscorer_core_action_after_header_options_map', 'topscorer_core_nav_menu_options' );
}