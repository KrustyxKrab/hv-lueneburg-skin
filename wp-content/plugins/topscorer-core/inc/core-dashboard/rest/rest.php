...
if ( ! class_exists( 'TopScorerCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class TopScorerCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'topscorer_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
	...
	TopScorerCoreDashboardRestAPI::get_instance();
}