...
if ( ! function_exists( 'topscorer_core_add_divided_header_meta' ) ) {
	function topscorer_core_add_divided_header_meta( $page ) {
	...
	add_action( 'topscorer_core_action_after_page_header_meta_map', 'topscorer_core_add_divided_header_meta' );
}