<div class="qodef-header-sticky">
    <div class="qodef-header-sticky-inner">
	    <div class="qodef-divided-header-left-wrapper">
		    ...
		    if ( is_active_sidebar( 'qodef-header-widget-area-two' ) ) { ?>
			    <div class="qodef-widget-holder">
				    <?php topscorer_core_get_header_widget_area( '', 'two' ); ?>
			    </div>
		    <?php }
		
		    // Include divided left navigation
		    topscorer_core_template_part( 'header/layouts/divided', 'templates/parts/left-navigation' ); ?>
	    </div>
	    ...
	    <div class="qodef-divided-header-right-wrapper">
		    ...
		    topscorer_core_template_part( 'header/layouts/divided', 'templates/parts/right-navigation' );
