...
if ( ! function_exists( 'topscorer_core_add_standard_header_options' ) ) {
	function topscorer_core_add_standard_header_options( $page ) {
		
		$section = $page->add_section_element(
			array(
				'name'        => 'qodef_standard_header_section',
				'title'       => esc_html__( 'Standard Header', 'topscorer-core' ),
				'description' => esc_html__( 'Standard header settings', 'topscorer-core' ),
				'dependency'  => array(
					'show'    => array(
	...
	add_action( 'topscorer_core_action_after_header_options_map', 'topscorer_core_add_standard_header_options', 10, 2 );
}