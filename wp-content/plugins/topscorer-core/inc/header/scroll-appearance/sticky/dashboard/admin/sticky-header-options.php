...
if ( ! function_exists( 'topscorer_core_add_sticky_header_options' ) ) {
	/**
	 ...
	 */
	function topscorer_core_add_sticky_header_options( $page, $section ) {
	...
	add_action( 'topscorer_core_action_after_header_scroll_appearance_options_map', 'topscorer_core_add_sticky_header_options', 10, 2 );
}

if ( ! function_exists( 'topscorer_core_add_sticky_header_logo_options' ) ) {
	/**
	 ...
	 */
	function topscorer_core_add_sticky_header_logo_options( $page, $header_tab ) {
	...
	add_action( 'topscorer_core_action_after_header_logo_options_map', 'topscorer_core_add_sticky_header_logo_options', 10, 2 );
}