...
class TopScorerCoreTopArea {
	...
	public function __construct() {
		...
		add_action( 'topscorer_action_before_page_header', array( $this, 'load_template' ) );
		...
		add_filter( 'topscorer_filter_add_inline_style', array( $this, 'set_inline_top_area_styles' ) );
	}
	...
	function is_top_area_enabled() {
		$top_area_enabled = topscorer_core_get_post_value_through_levels( 'qodef_top_area_header' ) === 'yes';
	...
	public function set_top_area_height() {
		if ( $this->is_top_area_enabled ) {
			$height         = topscorer_core_get_post_value_through_levels( 'qodef_top_area_header_height' );
	...
	public function is_top_area_transparent() {
		$background_color = topscorer_core_get_post_value_through_levels( 'qodef_top_area_header_background_color' );
	...
	public function load_template() {
		...
		topscorer_core_template_part( 'header/top-area/', 'templates/top-area', '', $parameters );
	}
	...
	public function set_inline_top_area_styles( $style ) {
		...
		$background_color = topscorer_core_get_post_value_through_levels( 'qodef_top_area_header_background_color' );
		$height           = topscorer_core_get_post_value_through_levels( 'qodef_top_area_header_height' );
		$padding          = topscorer_core_get_post_value_through_levels( 'qodef_top_area_header_side_padding' );
...
TopScorerCoreTopArea::get_instance();