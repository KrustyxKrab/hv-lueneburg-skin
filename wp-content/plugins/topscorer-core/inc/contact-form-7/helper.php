...
if ( ! function_exists( 'topscorer_core_get_contact_form_7_forms' ) ) {
	/**
	 ...
	 * @return array
	 */
	function topscorer_core_get_contact_form_7_forms( $enable_default = true ) {
		$options       = array();
		...
		if ( ! empty( $contact_forms ) ) {
			...
			$options[0] = esc_html__( 'No contact forms found', 'topscorer-core' );
		}
