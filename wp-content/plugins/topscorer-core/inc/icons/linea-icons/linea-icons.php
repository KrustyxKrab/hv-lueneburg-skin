...
if ( ! function_exists( 'topscorer_core_add_linea_icons_to_collection' ) ) {
	function topscorer_core_add_linea_icons_to_collection( $icons) {
		$icons[] = 'TopScorerCoreLineaIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'topscorer_core_add_linea_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TopScorerCoreLineaIconsPack extends QodeFrameworkIconPack {
