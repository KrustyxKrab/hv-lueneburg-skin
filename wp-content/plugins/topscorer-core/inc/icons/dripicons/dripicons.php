...
if ( ! function_exists( 'topscorer_core_add_dripicons_to_collection' ) ) {
	function topscorer_core_add_dripicon_to_collection( $icons ) {
		$icons[] = 'TopScorerCoreDripiconsIconPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'topscorer_core_add_dripicon_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TopScorerCoreDripiconsIconPack extends QodeFrameworkIconPack {
