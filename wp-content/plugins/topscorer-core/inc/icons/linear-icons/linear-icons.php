...
if ( ! function_exists( 'topscorer_core_add_linear_icons_to_collection' ) ) {
	function topscorer_core_add_linear_icons_to_collection( $icons ) {
		$icons[] = 'TopScorerCoreLinearIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'topscorer_core_add_linear_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TopScorerCoreLinearIconsPack extends QodeFrameworkIconPack {
