...
if ( ! function_exists( 'topscorer_core_add_elegant_icons_to_collection' ) ) {
	function topscorer_core_add_elegant_icons_to_collection( $icons ) {
		$icons[] = 'TopScorerCoreElegantIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'topscorer_core_add_elegant_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TopScorerCoreElegantIconsPack extends QodeFrameworkIconPack {
