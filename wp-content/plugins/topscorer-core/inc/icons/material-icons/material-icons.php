...
if ( ! function_exists( 'topscorer_core_add_material_icons_to_collection' ) ) {
	function topscorer_core_add_material_icons_to_collection( $icons ) {
		$icons[] = 'TopScorerCoreMaterialIconsPack';
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'topscorer_core_add_material_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TopScorerCoreMaterialIconsPack extends QodeFrameworkIconPack {
