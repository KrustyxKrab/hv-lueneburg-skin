...
if ( ! function_exists( 'topscorer_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function topscorer_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'TopScorerCore_Font_Awesome_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'topscorer_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TopScorerCore_Font_Awesome_Pack extends QodeFrameworkIconPack {
		...
		public function add_icon_pack() {
			...
			if ( method_exists( $this, 'get_new_icons_list' ) ) {
				$this->get_new_icons_list();
			}
		}

		public function get_style_url() {
			return TOPSCORER_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		private function icons_array() {
			return array_flip(
				array(
					...
					"Table Cells Row Unlock"                     => "fa fa-table-cells-row-unlock",
					...
					"Thumbtack Slash"                            => "fa fa-thumbtack-slash",
					"Ticket"                                     => "fa fa-ticket",
		...
		public function specific_icons() {
			return array(
				...
				'twitter'       => 'fab fa-x-twitter-square',
				'linkedin'      => 'fab fa-linkedin',
