...
if ( ! function_exists( 'topscorer_core_add_custom_font_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function topscorer_core_add_custom_font_shortcode( $shortcodes ) {
		$shortcodes[] = 'TopScorerCoreCustomFontShortcode';
		
		return $shortcodes;
	}
	
	add_filter( 'topscorer_core_filter_register_shortcodes', 'topscorer_core_add_custom_font_shortcode' );
}

if ( class_exists( 'TopScorerCoreShortcode' ) ) {
	class TopScorerCoreCustomFontShortcode extends TopScorerCoreShortcode {
		
		public function __construct() {
			$this->set_layouts( apply_filters( 'topscorer_core_filter_custom_font_layouts', array() ) );
			
			parent::__construct();
		}
		
		public function map_shortcode() {
			$this->set_shortcode_path( TOPSCORER_CORE_SHORTCODES_URL_PATH . '/custom-font' );
			$this->set_base( 'topscorer_core_custom_font' );
			$this->set_name( esc_html__( 'Custom Font', 'topscorer-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays custom font with provided parameters', 'topscorer-core' ) );
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'title',
				'title'      => esc_html__( 'Title Text', 'topscorer-core' )
			) );
			$this->set_option( array(
				'field_type'    => 'select',
				'name'          => 'title_tag',
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'font_family',
				'title'      => esc_html__( 'Font Family', 'topscorer-core' ),
				'group'      => esc_html__( 'Typography', 'topscorer-core' )
			) );
			$this->set_option( array(
				'field_type' => 'text',
			...
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'line_height',
				'title'      => esc_html__( 'Line Height', 'topscorer-core' ),
				'group'      => esc_html__( 'Typography', 'topscorer-core' )
			) );
			$this->set_option( array(
				'field_type' => 'text',
				'name'       => 'letter_spacing',
				'title'      => esc_html__( 'Letter Spacing', 'topscorer-core' ),
				'group'      => esc_html__( 'Typography', 'topscorer-core' )
			) );
			$this->set_option( array(
				'field_type' => 'select',
			...
			$this->set_option( array(
				'field_type' => 'select',
				'name'       => 'font_style',
				'title'      => esc_html__( 'Font Style', 'topscorer-core' ),
				'options'    => topscorer_core_get_select_type_options_pool( 'font_style' ),
				'group'      => esc_html__( 'Typography', 'topscorer-core' )
			) );
			$this->set_option( array(
				'field_type' => 'select',
			...
			$this->set_option( array(
				...
				'name'        => 'font_size_1366',
				'title'       => esc_html__( 'Font Size', 'topscorer-core' ),
				'description' => esc_html__( 'Set responsive style value for screen size 1366', 'topscorer-core' ),
				'group'       => esc_html__( 'Screen Size 1366', 'topscorer-core' )
			) );
			$this->set_option( array(
				'field_type'  => 'text',
			...
			$this->set_option( array(
				...
				'name'        => 'font_size_1024',
				'title'       => esc_html__( 'Font Size', 'topscorer-core' ),
				'description' => esc_html__( 'Set responsive style value for screen size 1024', 'topscorer-core' ),
				'group'       => esc_html__( 'Screen Size 1024', 'topscorer-core' )
			) );
			$this->set_option( array(
				'field_type'  => 'text',
			...
			$this->set_option( array(
				...
				'name'        => 'font_size_768',
				'title'       => esc_html__( 'Font Size', 'topscorer-core' ),
				'description' => esc_html__( 'Set responsive style value for screen size 768', 'topscorer-core' ),
				'group'       => esc_html__( 'Screen Size 768', 'topscorer-core' )
			) );
			$this->set_option( array(
				'field_type'  => 'text',
			...
			$this->set_option( array(
				...
				'name'        => 'font_size_680',
				'title'       => esc_html__( 'Font Size', 'topscorer-core' ),
				'description' => esc_html__( 'Set responsive style value for screen size 680', 'topscorer-core' ),
				'group'       => esc_html__( 'Screen Size 680', 'topscorer-core' )
			) );
			$this->set_option( array(
				'field_type'  => 'text',
		...
		public function render( $options, $content = null ) {
			...
			return topscorer_core_get_template_part( 'shortcodes/custom-font', 'variations/'.$atts['layout'].'/templates/custom-font', '', $atts );
		}
		...
		private function set_responsive_styles( $atts ) {
			...
			foreach ( $screen_sizes as $screen_size ) {
				...
				if ( ! empty( $styles ) ) {
					add_filter( 'topscorer_core_filter_add_responsive_' . $screen_size . '_inline_style_in_footer', function ( $style ) use ( $unique_class, $styles ) {
