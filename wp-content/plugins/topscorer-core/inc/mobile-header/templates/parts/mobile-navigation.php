<?php if ( has_nav_menu( 'mobile-navigation' ) || has_nav_menu( 'main-navigation' ) ) { ?>
	<nav id="qodef-mobile-header-navigation" class="qodef-m" role="navigation" aria-label="<?php esc_attr_e( 'Mobile Menu', 'topscorer-core' ); ?>">
		<?php
		...
		wp_nav_menu( array(
            ...
            'walker'          => new TopScorerCoreRootMainMenuWalker()
		) );
		?>
	</nav>
<?php } ?>