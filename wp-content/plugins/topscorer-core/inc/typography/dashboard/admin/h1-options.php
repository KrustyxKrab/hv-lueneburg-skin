...
if ( ! function_exists( 'topscorer_core_add_h1_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function topscorer_core_add_h1_typography_options( $page ) {
		...
		if ( $page ) {
			$h1_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h1',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H1 Typography', 'topscorer-core' ),
					'description' => esc_html__( 'Set values for Heading 1 html element', 'topscorer-core' )
				)
			);
			...
			$h1_typography_section = $h1_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'General Typography', 'topscorer-core' )
				)
			);
			...
			$h1_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Top', 'topscorer-core' ),
					'args'       => array(
						'col_width' => 3
					)
				)
			...
			$h1_1024_typography_section = $h1_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 1024 Typography', 'topscorer-core' )
				)
			);
			...
			$h1_768_typography_section = $h1_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 768 Typography', 'topscorer-core' )
				)
			);
			...
			$h1_680_typography_section = $h1_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 680 Typography', 'topscorer-core' )
				)
			);
	...
	add_action( 'topscorer_core_action_after_typography_options_map', 'topscorer_core_add_h1_typography_options' );
}