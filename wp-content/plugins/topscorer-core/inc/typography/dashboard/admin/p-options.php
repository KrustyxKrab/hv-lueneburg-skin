...
if ( ! function_exists( 'topscorer_core_add_p_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function topscorer_core_add_p_typography_options( $page ) {
		...
		if( $page ) {
			$paragraph_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-paragraph',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Paragraph Typography', 'topscorer-core' ),
					'description' => esc_html__( 'Set values for paragraph', 'topscorer-core' )
				)
			);
	...
	add_action( 'topscorer_core_action_after_typography_options_map', 'topscorer_core_add_p_typography_options' );
}