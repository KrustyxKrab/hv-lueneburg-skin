...
if ( ! function_exists( 'topscorer_core_add_h3_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function topscorer_core_add_h3_typography_options( $page ) {
		...
		if ( $page ) {
			$h3_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h3',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H3 Typography', 'topscorer-core' ),
					'description' => esc_html__( 'Set values for Heading 3 html element', 'topscorer-core' )
				)
			);
	...
	add_action( 'topscorer_core_action_after_typography_options_map', 'topscorer_core_add_h3_typography_options' );
}