...
if ( ! function_exists( 'topscorer_core_add_h5_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function topscorer_core_add_h5_typography_options( $page ) {
		...
		if ( $page ) {
			$h5_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h5',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H5 Typography', 'topscorer-core' ),
					'description' => esc_html__( 'Set values for Heading 5 html element', 'topscorer-core' )
				)
			);
	...
	add_action( 'topscorer_core_action_after_typography_options_map', 'topscorer_core_add_h5_typography_options' );
}